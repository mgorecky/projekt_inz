<template>
    <div class="main-panel border rounded p-5">
        <div class="text-center">
            <img class="w-25 p-3" src="../assets/logo.png">
            <br/>
            <h2>System anonimowego ankietowania</h2><br/>
            <h6>
                System zrealizowany w ramach kursu <b>'Projekt Inżynierski'</b> prowadzonego na <b>Uniwersytecie Pedagogicznym w Krakowie</b>.<br/>
                <b>Autor:</b> Mikołaj Górecki <b><a href="mailto:mikolaj.gorecki@student.up.krakow.pl">(mikolaj.gorecki@student.up.krakow.pl)</a></b><br/>
                <b>Repozytorium:</b> <a href="https://github.com/mgorecky/projekt_inz">GitHub</a><br/>
                <br/>
                <br/>
